...
import com.systemadminnotes.stodolist.ToDoView.ToDoItem;
...
public class SQLiteHelper extends SQLiteOpenHelper {
    ...
    //public static final String COULMN_PRIORITY = "prioritystate";

    //private static final String TODOTABLE = "CREATE TABLE " + TABLE_PRODUCTS + " (" +
    //        COLUMN_ID + " INTEGER PRIMARY KEY AUTOINCREMENT, "+ COLUMN_PRODUCTNAME + " TEXT " + COULMN_PRIORITY + " INTEGER " +
    //        ");";
    //private static final String DETAILTABLE = "CREATE TABLE " + TABLE_DETAILS + " (" +
    //        COLUMN_DETAILID + " INTEGER PRIMARY KEY AUTOINCREMENT, " + COLUMN_DETAILNAME + " TEXT, " + COLUMN_CHECKEDSTATE + " TEXT " + COULMN_PRIORITY + " INTEGER " +
    //        ");";
