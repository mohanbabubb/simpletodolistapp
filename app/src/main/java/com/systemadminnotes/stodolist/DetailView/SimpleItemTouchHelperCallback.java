package com.systemadminnotes.stodolist.DetailView;
...
public class SimpleItemTouchHelperCallback extends ItemTouchHelper.Callback {
    ...
    public SimpleItemTouchHelperCallback(Context context, DetailAdapter adapter) {
        mAdapter = adapter;
        mContext = context;
    }
    ...
    private void init() {
        ...
        initiated = true;
        ContextCompat.getDrawable(mContext, R.drawable.fab_background);
    }
