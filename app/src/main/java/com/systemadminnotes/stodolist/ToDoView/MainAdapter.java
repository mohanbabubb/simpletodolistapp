...
import com.systemadminnotes.stodolist.DetailView.DetailActivity;
...
public class MainAdapter extends RecyclerView.Adapter<MainAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(final ViewHolder viewHolder,  final int position) {
        ...
        viewHolder.dateText.setText("Created: "+ monthString + " " + day + ", " + year);
    ...
    //public void showTodoitemLongclick(int position){
    //}
}
